...
public class WindowSteps {
    ...
    @Then("^User switch to other window$")
    public void userSwitchToOtherWindow() {
        ...
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOfElementLocated(By.id("testpagelink")));
